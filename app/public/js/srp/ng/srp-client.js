angular.module( 'zenNetSRPClient', [] )

.factory( 'SRPClient', (function() {
    /*
    ...
    SRPClient.prototype = {
      ...
      /*
       * Calculate M1 = HASH( HASH(N) XOR HASH(PAD(g)) | HASH(I) | s | PAD(A) | PAD(B) | K )
       */
      calculateM1: function (A, B, ss, aa) {
        ...
        var u = this.calculateU( A, B );
        var S = this.calculateS( B, ss, u, aa );
        var K = this.calculateK( S );

        //
        return this.hexHash(
                ( new BigInteger( this.hexHash( this.N.toString( 16 ) ), 16 ) )
                    .xor( this.paddedHash( [ this.g.toString( 16 ) ] ) )
                    .toString( 16 ) +
                this.hash( I ) +
                ss +
                this.pad( A.toString( 16 ) ) +
                this.pad( B.toString( 16 ) ) +
                K
        );
      },

      /*
       * Calculate M2 = HASH( PAD(A) | M1 | K )
       */
      calculateM2: function (A, B, ss, aa) {

        var M = this.calculateM1( A, B, ss, aa );
      ...
      */
      ...
      pad: function( str ) {
          ...
          return this.nZeros(nlen - str.length) + str;
      },
    ...
    return function() {
        ...
        return function( username, password, group, hashFn ) {

            return new SRPClient( username, password, group, hashFn );
        };
    };
})() )
